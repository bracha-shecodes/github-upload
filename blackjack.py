            ...
            try:
                ...
                # Player move--> Stand (stop receving cards, Dealer turn)
                    ...
                    while playerMove == 2:
                        ...
                        elif ((player1.hand.total > 21) or (
                                (playerDealer.hand.total > player1.hand.total) or (playerDealer.hand.total == 21))):
                            WinGame(playerDealer, player1)
                            player1.PlayerBustGame()
                            playerMove = False
                            # Case player win: 17<dealer<21 and player>dealer
                        elif ((playerDealer.hand.total >= 17) and (playerDealer.hand.total < 21) and (
                                player1.hand.total >= playerDealer.hand.total)):
                            WinGame(player1, playerDealer)
                            player1.PlayerWinsGame()
                            playerMove = False
